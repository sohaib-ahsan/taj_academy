            ...
            <div class='row my-5'>
                ...
                <div class="col-md-10 my-4">
                    <div class='p-4 contlayout'>
                        <h2 class="tajText"> Students </h2>

                        <form action="searchStudent" method="post">
                            @csrf
                            <p class="m-2 mt-3 text-muted">Find Student</p>
                            <div class="col-md-8 label-select-container">
                        ...
                        <div class="mx-4 mt-3 text-muted fw-bold">Total Students: {{count($students)}}</div>
                        <div class="mx-4 text-muted fw-bold">Active Students: {{$active}}</div>
                        <div class="mx-4 mb-3 text-muted fw-bold">Inactive Students: {{count($students) - $active}}
                        </div>
                        ...
                        <div class='row'>
                            <div class="col-md-12 my-3">
                                <div class='p-4 contlayout border' style="min-height:43vh;">
                                    <div class="m-3">
                                        <span class="circle"></span><span class=" m-2 text-success">Active
                                            Students</span>
                                    </div>
                                    <table class="table table-hover ">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="text-center align-middle" style="width: 15%;">
                                                    Roll No.</th>
                                                <th scope="col" style="padding-left: 30px;" style="width: 40%;">Name
                                                </th>
                                                <th scope="col" class="text-center align-middle" style="width: 45%;">
                                                    Course</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="clickTable" data-student-id="{{$student->std_id}}"
                                                ...
                                                <td style="padding-left: 30px;">{{$student->name}}</td>
                                ...
                                <div class='p-4 mt-4 contlayout border' style="min-height:20vh;">
                                    <div class="m-3">
                                        <span class="circle" style="background-color:red;"></span>
                                        <span class=" m-2 text-danger">Inactive Students</span>
                                    </div>
                                    <table class="table table-hover ">
                                        <thead>
                                            <tr>
...
<script>
    ...
    function redirectToStudentDetails(id) {
        ...
        window.location.href = "{{url('studentIdDetails')}}" + studentId;
    }
</script>
