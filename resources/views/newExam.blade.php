                ...
                <div class="col-md-6 my-4">
                    <div class='p-4 contlayout'>
                        ...
                        <div class="d-flex my-4 justify-content-between align-items-center">
                            <h3 class="tajText"> New Exam </h3>
                        </div>

                        <form id='form' action="{{route('newExamSubmit')}}" method="post">
                            @CSRF

                            <div class="my-3 label-select-container align-items-center">
                                <label for="exam" class="form-label  mx-2 px-2 mt-2">Exam</label>
                                <input type="text" name="exam" class="form-control" required>
                            </div>

                            <div class="my-3 label-select-container align-items-center">
                                <label for="marks" class="form-label  mx-2 px-2 mt-2">Total Marks</label>
                                <input type="number" name="marks" class="form-control" required>
                            </div>

                            <div class="my-3 label-select-container align-items-center">
                                <label for="date" class="form-label  mx-2 px-2 mt-2">Date</label>
